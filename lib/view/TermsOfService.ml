let render request =
  ...
  let html =
    Layout.Default.layout
      ...
      ; h2 [ txt "2. Open Source Disclaimer" ]
      ...
      ; h2 [ txt "3. Comment Section Disclaimer" ]
